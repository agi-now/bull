...
const dict = {
  en: {
    ...
    hero_badge: '~18 MB · 5 Engines · 72 Commands · Zero Dependencies',
    ...
    feat_1_desc: 'One ~18 MB executable. No runtime, no containers, no package managers. Just copy and run.',
  ...
  zh: {
    ...
    hero_badge: '~18 MB · 5 大引擎 · 72 条命令 · 零外部依赖',
    hero_title_1: '一个二进制。',
    hero_title_2: '五大引擎。',
    hero_title_3: '无限可能。',
    ...
    feat_1_title: '单个二进制',
    feat_1_desc: '约 18 MB 的可执行文件。无运行时、无容器、无包管理器。复制即用。',
    feat_2_title: '五大引擎',
